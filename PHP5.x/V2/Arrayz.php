...
class Arrayz
{
	...
	*/
	...
	{
		$args = func_get_args();
		$this->worker['whereIn'] = ['search_key' => $args[0], 'search_value' => $args[1],'preserve'=> $preserve = isset($args[2]) ? $args[2] : TRUE];
	...
	{
		$args = func_get_args();
		$this->worker['whereNotIn'] = ['search_key' => $args[0], 'search_value' => $args[1], 'preserve'=> isset($args[2]) ? $args[2] : TRUE];		
	...
	*/
	...
	{
		$args = func_get_args();
		$this->worker['limit'] = ['limit' => ($args[0]!=1 ? $args[0]+1 : $args[0]) , 'offset' => (isset($args[1]) ? $args[1] : 0 ), 'preserve' => (isset($args[2]) ? $args[2] : TRUE)];		
